...
export default function Home() {
  ...
  return (
    <>
      <div
        id="home"
        className="flex w-screen h-screen justify-center items-center -z-10"
      >
        <div
          className="card-home rounded-lg text-center w-[80vw] max-w-[500px]"
          ref={homeRef}
          draggable={true}
        >
          ...
          <div className="flex flex-wrap gap-5 w-full place-content-around">
            ...
            <a
              className="icon"
              href="https://www.linkedin.com/in/ivan-scaglioni-6b7719221/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <BsLinkedin size={40} />
