...
export default function Home() {
  ...
  return (
    <>
      <div id='home' className='flex w-screen h-screen justify-center items-center -z-10 text-5xl'>
        
        <div className="card-home rounded-lg " ref={homeRef} draggable={true} >
          
          <div className="name m-3 font-bold rounded-md p-3">
          IVAN SCAGLIONI
          </div>


          <div className="web flex justify-center rounded-sm m-4 p-3">
            web developer
          </div>
